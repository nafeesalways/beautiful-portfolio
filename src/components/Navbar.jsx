    ...
    <div>
      <div className="navbar bg-black text-white shadow-sm mb-6">
        ...
        <div className="navbar-end">
          <a className="btn border border-blue-500/50 text-blue-400 lg:py-3 lg:px-6 rounded font-medium transition hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)] hover:bg-blue-500/10">
            Resume
          </a>
        </div>
      </div>
