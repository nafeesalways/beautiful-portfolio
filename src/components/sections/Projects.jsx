...
const projectData = [
  {
    ...
    techStack: ['React', 'Tailwind CSS', 'Firebase', 'MongoDB','Firebase'],
  ...
  },
   {
    ...
    description: 'A smart inventory management web app that helps users track food items,details and get expiry alerts.',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1551543801-fb7bdeb9fc4a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y291cnRzfGVufDB8fDB8fHww',
